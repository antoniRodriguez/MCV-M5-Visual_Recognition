...
cfg.merge_from_file(model_zoo.get_config_file("Cityscapes/mask_rcnn_R_101_FPN.yaml"))

cfg.MODEL.RETINANET.SCORE_THRESH_TEST = 0.5  # set threshold for this model

cfg.MODEL.WEIGHTS = model_zoo.get_checkpoint_url("Cityscapes/mask_rcnn_R_101_FPN.yaml")
...
print(results)
with open('model_trained_Cityscapes.pkl', 'wb') as f:
