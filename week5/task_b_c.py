...
path = '/home/group00/working/week5/img_task_C'
...
if not evaluate_differences:
    for idx,model_path in enumerate(models):
        output_path = f"/home/group00/working/week5/test_outs_task_C/{model_path[:-5]}/"
        ...
        if type(image_paths)==list:
            ...
            if save_pkl:
                ...
                f = open('week5/keyboard_task_C_outs'+str(idx)+'.pkl', 'wb')
                pickle.dump(dictionary, f)
                f.close()
else:
    f = open('/home/group00/working/week5/keyboard_task_b_outs.pkl', 'rb')
    keyboard_results_dictionary = pickle.load(f)
    f.close()

    f = open('/home/group00/working/week5/unmodified_task_b_outs.pkl', 'rb')
    ...
    for idx in tqdm(range(n_images)):
        ...
        if save_images:
            ...
            keyboard = '/home/group00/working/week5/test_outs_task_B_keyboard_dining_table_/'
            unmodified = '/home/group00/working/week5/test_outs_task_B_unmodified_dining_table_/'
